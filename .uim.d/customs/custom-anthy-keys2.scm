(define anthy-on-key '("zenkaku-hankaku" "hangul"))
(define anthy-on-key? (make-key-predicate '("zenkaku-hankaku" "hangul")))
(define anthy-off-key '("zenkaku-hankaku" "hangul"))
(define anthy-off-key? (make-key-predicate '("zenkaku-hankaku" "hangul")))
